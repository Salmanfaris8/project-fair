...
const Edit = ({project}) => {
  ...
  return (
    <>
      <button className='btn' onClick={handleShow}><i className='fa-solid fa-edit text-success'></i></button>
      <Modal
        size='lg' 
        centered
        show={show}
          ...
          <div className="row align-items-center mx-3">
            <div className="col-lg-4">
              <label>
                ...
                <img width={'200px'} className='img-fluid' src={preview?preview:`${SERVER_URL}/uploads/${project.projectImg}`} alt="" />
              </label>
