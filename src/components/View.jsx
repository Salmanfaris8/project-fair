            ...
            userProjects?.map(project=>(
              <div className="border rounded p-2 d-flex justify-content-between mb-3">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="btn"><a target='_blank' href={project.github}><i className="fa-brands fa-github text-black"></i></a></div>
                  <button onClick={()=>deleteProject(project?._id)} className='btn text-danger'><i className="fa-solid fa-trash"></i></button>
                </div>
              </div>
              ))
              :
              <div className="text-warning fw-bolder">User not uploaded any projects yet!!!</div>
            }
          </div>
    </>
  )
